...
const BottomNavigation: React.FC = () => {
	...
	return (
		<>
			<div className="md:hidden fixed z-10 bottom-0 flex items-center justify-between shadow-bottomNavigation text-gray-700 body-font bg-black w-full h-14 sm:h-16 px-4">
				<button
					aria-label="Menu"
