...
const Copyright: React.FC<CopyrightProps> = ({ payment }) => {
	...
	return (
		<div className="border-t border-gray-300 pt-5 pb-16 sm:pb-20 md:pb-5 mb-2 sm:mb-0">
			<Container className=" text-white flex flex-col-reverse md:flex-row text-center md:justify-between">
				<p className=" text-white text-body text-xs lg:text-sm leading-6">
