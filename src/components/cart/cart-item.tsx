	...
	return (
		...
		>
			...
			<Image
				...
				/>
				<div
					className="absolute top-0 start-0 h-full w-full  bg-opacity-30 md:bg-opacity-0 flex justify-center items-center transition duration-200 ease-in-out md:group-hover:bg-opacity-30"
