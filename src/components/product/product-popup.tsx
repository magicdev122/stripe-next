				...
				<div className="flex flex-col p-5 md:p-8 w-full">
					<div className="pb-5">
						<div
							...
							role="button"
						>
							<h2 className="text-heading  text-white text-lg md:text-xl lg:text-2xl font-semibold hover:text-black">
								{data.name}
							</h2>
						</div>
						<p className="text-sm leading-6 text-white md:text-body md:leading-7">
							{data.description}
						</p>

						<div className="flex items-center mt-3">
							<div className="text-heading text-white font-semibold text-base md:text-xl lg:text-2xl">
								{data.price}$
							</div>
