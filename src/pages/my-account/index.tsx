...
export default function AccountPage() {
	...
	return (
		<AccountLayout>
			<h2 className=" text-white text-lg md:text-xl  xl:text-2xl font-bold text-heading mb-3 xl:mb-5">
				{t("text-dashboard")}
			</h2>
			<p className="text-white text-sm leading-7 md:text-base md:leading-loose lowercase">
